...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text="Sign Language traduction", font=("Times New Roman", 30, "bold"))
        ...
        self.panel99 = tk.Label(self.root)  #corrected
        self.panel99.place(x=390, y=700)
        ...
        self.next_button.place(x=1005, y=630)
        self.next_button.config(text="Space", font=("Times New Roman", 20), wraplength=100 ,command=self.space_fun)

        self.next_button = tk.Button(self.root)
        self.next_button.place(x=1305, y=630)
        self.next_button.config(text="Ckeck text", font=("Times New Roman", 20), wraplength=150, command=self.correct_fun)
    ...
    def video_loop(self):
        try:
            ...
            self.panel99.config(text=self.predicted_text, font=("Times New Roman", 30))
        except Exception:
    ...
    def speak_fun(self):
        self.speak_engine.say(self.predicted_text)
    ...
    def correct_fun(self):
        parser = GingerIt()
        result = parser.parse(self.str)
        corrected_sentence = result['result']
        self.predicted_text = corrected_sentence
    ...
    def chatgpt_fun(self):
        # Set up the OpenAI API client
        openai.api_key = "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"

        # Set up the model and prompt
        model_engine = "text-davinci-003"
        prompt = "hello can u make this text correct and clear:" + self.str
